package ru.relex.minisocialnetwork.handler;
...
import ru.relex.minisocialnetwork.exception.*;
import ru.relex.minisocialnetwork.model.dto.ApiErrorDto;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ApiErrorDto> forbiddenException(final RuntimeException runtimeException) {
        final ApiErrorDto apiErrorDto = ApiErrorDto.builder()
